<div class="mw-container">
	<div>
		<!-- IF isServerOnline -->
			<!-- IF icon -->
				<img src="{icon}" style="float: left; height: 50px; margin-right: 0.75em;">
			<!-- ELSE -->
		...
		<span style="float: right; margin-top: 0.325rem;"><span class="mwOnlinePlayers">{onlinePlayers}</span>/{maxPlayers}</span>
